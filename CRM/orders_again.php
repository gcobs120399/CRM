...
//未加限制顯示筆數的SQL敘述句
$query_RecFlower = "SELECT o_no,sex, COUNT(*) AS `B_count` FROM order1 GROUP BY o_no HAVING COUNT(*)>1";
...
<br><br><br>
<h1 style="text-align:center;">續買分析</h1>
<hr>
<div class=" col-xs-3 col-md-3" style="background: rgba(100%,100%,100%,0.6); margin: 0 auto;">
  ...
  <a href="orders_together.php" style="text-align:center;font-size: 30px;font-family: 微軟正黑體;font-weight: bold;color: red"><img src="newimg/20.png" alt="LOGO" width="80" height="50">合買分析</a><br>
  <a href="orders_again.php" style="text-align:center;font-size: 30px;font-family: 微軟正黑體;font-weight: bold;color: red"><img src="newimg/20.png" alt="LOGO" width="80" height="50">續買分析</a><br>
  <a href="orders_sale.php" style="text-align:center;font-size: 30px;font-family: 微軟正黑體;font-weight: bold;color: red"><img src="newimg/20.png" alt="LOGO" width="80" height="50">促銷成效分析</a><br>
</div>
<div class="container col-xs-8 col-md-8">
  ...
  <div style="background: rgba(100%,100%,100%,0.6); margin: 0 auto;"><!--div放白色背景透明度60%開始-->
    ...
    <table width="100%" border="0px" cellspacing="0" cellpadding="10" style="font-size: 20px;">
      <tr valign="top">
        <td class="tdrline"><p class="title" style="text-align: center;font-size: 24px;">續買分析</p>
